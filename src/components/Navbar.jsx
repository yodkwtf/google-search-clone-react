...
const Navbar = ({ setDarkTheme, darkTheme }) => {
  return (
    <nav className="max-w-screen-2xl mx-auto px-5 py-3 flex flex-wrap justify-center items-center sm-justify-between border-b border-gray-300 dark:border-gray-500">
